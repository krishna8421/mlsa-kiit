  ...
  return (
    <>
      ...
      <div className="projectsAnimation mt-8 flex flex-col items-center justify-center duration-500 ease-out smm:mt-2">
        <h1 className="animate-[fadeinout_10s] bg-gradient-to-b  from-[#5051F9] to-[#AE86E0] bg-clip-text text-3xl font-bold text-transparent smm:h-[2.5rem] md:h-[3rem] md:text-4xl lg:h-[4rem] lg:text-5xl">
          Projects
        </h1>
        <div className="text-md mt-2 md:text-lg lg:text-xl">
          <p className="animate-[fadeinout_15s] text-center">
          ...
          <div className="mt-4 flex animate-[fadeinout_16s] justify-between bg-gradient-to-b from-[#5051F9] to-[#AE86E0] bg-clip-text text-transparent">
