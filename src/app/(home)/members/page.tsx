    ...
    <div className="wrapper-outer h-[100vh]">
      <div className="wrapper h-full overflow-x-hidden ">
        ...
        <div className=" teams-gradient parallax-section min-h-[90vh] p-[5px] flex items-center justify-center w-[100vw] relative ">
          <div className=" parallax-bg absolute top-0 bottom-0 left-0 right-0 bg-cover -z-10 min-h-full object-fill lg:object-cover"></div>
           <Image src="/Members/members.png" width={3000} height={100} alt="members" className="parallax-bg absolute top-[-50px] bottom-0 left-0 right-0 bg-cover -z-10 min-h-full object-cover"></Image>
          ...
          <Image src="/Rectangle-shadow.svg" width={400} height={400} alt="members" className=" hidden sm:block absolute right-0 bottom-[-450px] z-50"></Image>
