...
const Gallery = () => {
  ...
  return (
    <>
      <div className="flex 2xl:h-screen  mt-[100px] md:mt-[120px] 2xl:mt-[50px] 2xl:items-center md:pl-16 3xl:pl-16 max-w-[1920px] mx-auto">
        <div className="flex md:flex-row flex-col justify-between pb-[45px] md:pb-[100px] 2xl:pb-[0px] w-full ">
        <div className="flex flex-col items-center md:items-start">
          <h1 className="bg-gradient-to-b from-[#5051F9] to-[#AE86E0] bg-clip-text text-3xl h-[2.4rem] font-bold text-transparent md:text-4xl lg:text-5xl  3xl:text-7xl md:h-[2.8rem] lg:h-[3.6rem] 3xl:h-[5.2rem]">
            Gallery
          </h1>
          <div className="text-md mt-1 lg:mt-2 md:text-lg lg:text-xl">
            <p className="text-xl md:text-[27px] lg:tracking-wider 2xl:text-3xl 3xl:text-[40px]">Our Past Successful Events</p>
        ...
        <div className="relative -translate-x-3 sm:-translate-x-6 md:translaye-x-0 mx-auto md:mx-[0px] mt-[30px] md:ml-[0px] md:mt-0 md:mr-[7vw] h-[300px] md:h-[400px] lg:h-[450px] 2xl:h-[500px] w-[85vw] sm:w-[70vw] md:w-[40%] object-cover lg:max-h-[600px] 3xl:w-[45%]">
