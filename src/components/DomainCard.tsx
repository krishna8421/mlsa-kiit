    ...
    <>
      ...
      <div
        className={`${isHome ? "4xl:h-[319px] 4xl:max-w-[475px] " : " h-[120%] shadow-blue"
          } relative rounded-[5px] group transition duration-1000 lg:rounded-[8px] 2xl:rounded-[15px] pb-2 pt-[10.93px] pr-[6.53px] md:pr-[17px] bg-[#111]  border-[#838383] border gradient-border   hover:shadow-blue h-180px md:h-[200px] xl:h-[235px] 2xl:h-[280px] 2xl:max-w-[370px] sm:max-w-[191px] max-w-[132px] h-[121px] md:max-w-[280px] xl:max-w-[280px] md:mt-[60px] 2xl:mt-[122px] sm:mt-[44px] mt-[38px] `}
      >
        <div
        ...
        <p
          className={`${isHome ? "md:ml-[32px]  4xl:text-xl" : "mx-5  pb-5 text-xl "
            } ml-[5px] sm:ml-[12.92px] 2xl:mt-[46px] mb-1 lg:mt-[44px] md:mt-[35px] sm:mt-[25.83px] mt-[12.35px] 2xl:leading-[26.6px] md:leading-[15px] leading-normal font-light 2xl:text-[16px] md:text-[13px] text-[7px] text-[#c8c7c7]  transition duration-500 group-hover:text-[#FFFFFF]`}
        >
          {about}
        </p>
      </div>
