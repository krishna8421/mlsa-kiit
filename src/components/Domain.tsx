...
const Domain: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-[100px] pl-8 overflow-y-hidden pt-10 md:pl-[50px] lg:pl-[80px] xl:pl-[90px] 2xl:pl-[130px] mt-[100px] h-auto md:pb[222px] pb-[128px] relative z-0 flex flex-row max-w-[1920px] justify-center items-center mx-auto">
