...
const AboutCard = ({ icon, label, Classname, content }: aboutCardProps) => {
  return (
    <>
      <div
        className={`md:max-w-[330px] md:w-[35vw] flex-shrink-0 lg:w-[30vw] lg:max-w-[350px] 3xl:max-w-[423px] xl:w-[20vw] lg:min-w-[280px] w-full group rounded-xl bg-[#252525]/50 px-4 md:py-6 lg:py-4 duration-400 transition shadow-lg hover:shadow-aboutContainerShadow ${Classname}`}
      >
        ...
        <p className="pt-8 text-[#7d8590] duration-400 transition text-base xl:text-base group-hover:text-white 3xl:text-xl">
          {content}
        </p>
      </div>
    </>
