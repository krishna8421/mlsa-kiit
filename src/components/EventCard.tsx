...
const EventCard = () => {
    ...
    return (
        <>
            ...
            <div className="max-w-[1920px] pt-[100px] bg-black mx-auto p-[5vw]  ">
                ...
                <div className=" flex flex-row">
                    <div className="relative">
                        ...
                        <div className="absolute bottom-[72px] left-[18px] text-xl 3xl:text-3xl font-medium">Eye S.py Squid</div>
                    ...
                    {EVENTS2023.map((event, index) => {
                        ...
                        return (<>
                            ...
                            <div key={index} className="relative group gallery-gradient overflow-hidden rounded-[4px] lg:rounded-[4px]  w-full h-[300px] sm:h-[22vw] lg:h-[19.21vw] 3xl:h-[369px]">
                                ...
                                <div className="absolute bottom-4 right-4 z-50 text-white text-base 3xl:text-3xl font-normal ">View More</div>
                            </div>
            ...
            {check == false ? (
                <><div className="h-[1px] w-[83%] mx-[3.8rem] my-auto bg-[#FFFFFF] group-hover:bg-gray-300"></div><div className="flex justify-end mr-[4rem] mt-[-1rem] cursor-pointer mb-2 text-lg" onClick={() => { setcheck(true); }}>View More</div></>) : (<></>)
            }
