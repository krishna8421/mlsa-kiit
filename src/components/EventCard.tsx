            ...
            <div className="max-w-[1920px] pt-[100px] bg-black mx-auto p-[5vw]  ">
                ...
                <div className=" flex flex-row">
                    <div className="relative">
                        <img src="./eyeSpySquid.jpg" alt="image" className="w-[680px] h-[300px] ml-[0.22rem] mb-[1.5rem] rounded relative object-cover object-center group hover:shadow-blue2 transition duration-500 hover:ease-in-out" />
