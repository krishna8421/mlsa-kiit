  ...
  return (
    ...
    <div className=" no-repeat h-[92vh] w-full bg-[url('/EventHero.png')] bg-cover  bg-center bg-no-repeat">
      <div className="  mx-auto h-[100px] w-[93%]  text-right text-white">
        ...
        <div className={`${anotherHand.className} registerNow relative mr-[7%]  mt-6`}>
    ...
    <h1 className="bg-gradient-to-br from-[#5051F9]  to-[#DFDFFF] leading-20 font-semibold text-transparent bg-clip-text">Events</h1>
    <h2 className="text-[33px]">Our Past successfull events</h2>
  </div>
  </div>
  );
};
