...
const AlumuniCard = ({ image, name, position, company, message }: Props) => {
  return (
    <div className=" w-[300px] md:w-[480px] mx-8 sm:mx-6 md:mx-10 my-10 md:my-24 h-[200px]  md:h-[250px]">
      ...
      <div className="backdrop-blur-[5px] h-[190px] md:h-[240px] overflow-hidden hover:shadow-blue2 mx-1 md:mx-3  box-border flex flex-col rounded-[10px] border-[1px] border-solid border-white bg-[#25252580] px-4 md:px-5 py-4 text-start font-sans  font-normal text-white">
        <div>
